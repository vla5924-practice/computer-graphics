...
QColor TLinearCorrectionFilter::caclulatePixelColor(QColor color, const std::vector<float>& metrics)
{
...
std::vector<float> TLinearCorrectionFilter::calculateMetrics(const QImage& image)
{
