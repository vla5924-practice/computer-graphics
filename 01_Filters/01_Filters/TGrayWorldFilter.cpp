...
QColor TGrayWorldFilter::caclulatePixelColor(QColor color, const std::vector<float>& metrics)
{
...
std::vector<float> TGrayWorldFilter::calculateMetrics(const QImage& image)
{
