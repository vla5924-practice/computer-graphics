...
QColor TDynamicMatrixFilter::calculatePropertyColor(const QColor* colors, int colorsCount) const
{
...
int TDynamicMatrixFilter::calculateProperty(int* values, int valuesCount) const
{
    return 0;
}
