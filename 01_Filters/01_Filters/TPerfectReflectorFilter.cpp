...
QColor TPerfectReflectorFilter::caclulatePixelColor(QColor color, const std::vector<float>& metrics)
{
...
std::vector<float> TPerfectReflectorFilter::calculateMetrics(const QImage& image)
{
