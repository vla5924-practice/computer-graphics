...
QColor TReferenceColorFilter::caclulatePixelColor(QColor color, const std::vector<float>& metrics)
{
...
std::vector<float> TReferenceColorFilter::calculateMetrics(QColor sourceColor, QColor controlColor)
{
...
QImage TReferenceColorFilter::applyToImage(const QImage& image, QPoint controlPixel, QColor controlColor)
{
